        ...
        <tbody>
            <c:forEach items="${itemList}" var="item">
                        <tr>
                                ...
                                <td>
                                    <div>
                                        <a href="javascript:void(0)" onclick="addIntoCart(${item.id},${item.price})">加入购物车</a>
                                        <a href="${pageContext.request.contextPath}/myCollection/addCollection?item_id=${item.id}&user_id=${sessionScope.user.id}">收藏</a>
                                    </div>
                                </td>
                        </tr>
    ...
    <table>
        ...
        <c:forEach items="${goodsList}" var="goods">
            <tr>
                <td>${goods.name}</td>
                <td>${goods.price}</td>
                <td><img width="120px" height="120px" src="${pageContext.request.contextPath}/resources/img/${goods.image}"  ></td>
                <td>${goods.image}</td>
                <td>
